				...
				<b-tab title="Library" active>
					...
					<div v-if="firebaseData" class="content">
						...
						<b-table-simple striped table-class="table-vcenter">
							<b-thead>
								<b-tr>
									<b-th style="width: 50%">Questions</b-th>
									<b-th class="d-none d-lg-table-cell text-center" style="width: 12%">Category</b-th>
							...
							<b-tbody>
								<b-tr v-for="(ques, index) in filteredArray" :key="index">
									<b-td>
										...
										<p class="d-none d-sm-block text-muted">{{ String(ques.options).slice(0, 30) }}...</p>
									</b-td>
